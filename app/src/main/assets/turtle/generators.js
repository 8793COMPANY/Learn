...
//        var type = Blockly.JavaScript.valueToCode(block, 'TYPE', Blockly.JavaScript.ORDER_ATOMIC);
     ...
     Blockly.JavaScript['oled_clear'] = function(block) {
...
//    };
    ...
    //      return [code, Blockly.JavaScript.ORDER_ATOMIC];
        ...
        /*
         * 태양광 자동 추적
         * 원본: 6_solar_tracking.ino
         */
        Blockly.JavaScript['solar_tracking'] = function(block) {

          // 라이브러리와 전역 변수
          Blockly.JavaScript.definitions_['solar_tracking_definitions'] =
        `#include <Servo.h>
        ...
        `;
          ...
          // setup()에 들어갈 코드
          Blockly.JavaScript.setups_['solar_tracking_setup'] =
         ...
         * 원본: 7_voltage.ino
         */
        Blockly.JavaScript['solar_voltage'] = function(block) {

          // 라이브러리, 전역 변수, OLED 출력 함수
          Blockly.JavaScript.definitions_['solar_voltage_definitions'] =
        `#include <Adafruit_SSD1306.h>
        ...
        `;
          ...
          // setup()에 들어갈 코드
          Blockly.JavaScript.setups_['solar_voltage_setup'] =
        `Serial.begin(9600);
        ...
        /*
         * 스마트 태양광 추적기
         * 원본: 10_solar_tracker.ino
         *
         * 기능:
         * 1. 조도센서 4개로 태양광 방향 추적
         * 2. 서보모터 2개 제어
         * 3. 태양광 전압 측정
         * 4. OLED 전압 표시
         * 5. 네오픽셀 전압 게이지 표시
         */
        Blockly.JavaScript['solar_tracker'] = function(block) {

          // 라이브러리, 전역 변수, 전압 출력 함수
          Blockly.JavaScript.definitions_['solar_tracker_definitions'] =
        `#include <Servo.h>
        #include <Adafruit_SSD1306.h>
        #include <Adafruit_NeoPixel.h>
        ...
        `;
          ...
          // setup()에 들어갈 코드
          Blockly.JavaScript.setups_['solar_tracker_setup'] =
        `Serial.begin(9600);
        ...
        if (abs(diffazi) >= threshold_value) {
          if (diffazi > 0) {
            if (servo_rightleft.read() > 0) {
              servo_rightleft.write(
                servo_rightleft.read() - 1
              );
            }
          }
          else if (diffazi < 0) {
