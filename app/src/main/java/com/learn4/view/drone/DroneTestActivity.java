...
public class DroneTestActivity extends AppCompatActivity implements View.OnClickListener {
...
//    LinearLayout layout_trim;
    Button btn_trim_forward;
    Button btn_trim_left;
    Button btn_trim_right;
    Button btn_trim_backward;
    Button btn_x12510;
    Button btn_version;
    Button btn_rgb_id;
    SeekBar seek_r;
    ...
    int cen_w_right_btn = 0;
    int cen_h_right_btn = 0;
    int cen_w_right_circle = 0;
    int cen_h_right_circle = 0;
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()){
                    ...
                    case 1:
                        cal = true;
//                        rgbNcal = true;
//                        myHandler.sendEmptyMessageDelayed(30, 500);
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                Log.e("touch", "calibration hanlder");
                                rgbNcal = true; // 됨
                            }
                        }, 500);
