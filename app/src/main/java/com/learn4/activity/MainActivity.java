...
import com.learn4.R;
import com.learn4.dialog.FinishDialog;
import com.learn4.dialog.ProgressDialog;
import com.learn4.dialog.UploadDialog;
import com.learn4.dto.CodeBlock;
...
*/
    ...
    public Boolean OpenUSB() {
        ...
        if(initial) {
            Log.e("openUsb true","!!");
            initial = false;
            Application.mPhysicaloid.upload(Boards.ARDUINO_UNO, "/data/data/com.learn4/code.ino");
            return initial;
        }
        else {
            Log.e("openUsb false","!!");
