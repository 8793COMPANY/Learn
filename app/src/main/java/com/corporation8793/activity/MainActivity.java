...
//                            customProgressDialog.dismiss();
    ...
    public void upload_code(String file){
        ...
        Log.e("isOpend",Application.mPhysicaloid.isOpened()+"");
...
//        Log.e("hello category",categoryData.getUpload_btn().isSelected()+"");
    Log.e("hello end","check");
...
//                dictionary_block_list.add(new CodeBlock("2","Setup","아두이노에서 무슨 PIN을 어떻게 사용할지 정하는 곳",R.drawable.problem_block5));
    ...
    public void FinishLoad(PushEvent mPushEvent) {
        // 이벤트가 발생한뒤 수행할 작업
        Log.e("hello", "finishLoad"+mPushEvent.getPos());

        if (!usb_check && Application.usb_check) {
            usb_check = true;
            Log.e("hello", "first");
        }
...
//                }
//                if (current_pos != 11) {
//                    view_check[current_pos] = false;
//                    if (current_pos>3)
//                        tempTab[current_pos-4].setSelected(false);
//                }
//                current_pos = 11;
//                setCategoryTabsColor(10);
//                setMonitor(10);
...
//                block_dictionary.setVisibility(View.GONE);
                ...
                Log.e("default isClosed",categoryData.isClosed()+"");
                Log.e("default isSelected",categoryData.isSelection()+"");
                ...
                if(mPushEvent.getPos() < 4) {
                    ...
                    initTabCheck();
                    break;
                } else if (mPushEvent.getPos() >= 4   && mPushEvent.getPos() != 11){
                    loadXmlFromWorkspace();
                    initTabColor();
...
//        }
    ...
    void setMonitor(int position){
        Log.e("check tempTab",tempTab[position-4].isSelected()+"");
...
//                setInitLine();
    ...
    public void setCategoryTabsColor(int position){
        Log.e("setCategoryTabsColor current_pos",current_pos+"");
        Log.e("setCategoryTabsColor position",position+"");
        Log.e("setCategoryTabs",view_check[position]+"");
        if (current_pos == position) {
            if (view_check[position]){
                trashcan_btn.setVisibility(View.INVISIBLE);
                block_bot_btn.setVisibility(View.INVISIBLE);
...
//        }
        ...
        // 웰컴 메시지 재생
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.bot_test_lv1_led_into_contents_5_into_workspace);
        mediaPlayer.start();
...
//        return "http://learnserver24.com:5000";
    ...
    public void onClickTest(View v, int pos) {
        ...
        Log.e("onclick initTabCheck - case", tempTabCheck[0] + ", " + tempTabCheck[1] + ", " + tempTabCheck[2] + ", "
                    +tempTabCheck[3] + ", " + tempTabCheck[4] + ", " + tempTabCheck[5] + ", ");

        Log.e("onclick initTabColor - case", tempTab[0] + ", " + tempTab[1] + ", " + tempTab[2] + ", "
                +tempTab[3] + ", " + tempTab[4] + ", " + tempTab[5] + ", ");
        if (pos >= 4) {
            Log.e("pos",pos+"");
            tempTab[pos-4] = v;
...
//                if (tempTab[pos-4].isSelected()) {
//                    Log.e("case 9 true","in");
//
//                    tempTab[pos-4].setSelected(false);
//                }else {
//                    Log.e("case 9 false","in");
//
//                    tempTab[pos-4].setSelected(true);
//                }
                break;
